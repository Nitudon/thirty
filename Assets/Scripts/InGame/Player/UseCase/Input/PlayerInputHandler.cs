...
{
    private readonly Subject<Vector2> _onBeginDragPosition;
    public Subject<Vector2> OnBeginDragPosition => _onBeginDragPosition;

    private readonly ReactiveProperty<Vector2> _dragDelta;
    public ReactiveProperty<Vector2> DragDelta => _dragDelta;

    private readonly Subject<Vector2> _onEndDragPosition;
